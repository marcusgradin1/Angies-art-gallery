(function(){
  ...
  const cleanup=document.createElement('style');cleanup.textContent=".visual:before,.art:before,.art:after{display:none!important}.art{width:min(84%,32rem)!important;box-shadow:none!important}";document.head.append(cleanup);
  const copy={
